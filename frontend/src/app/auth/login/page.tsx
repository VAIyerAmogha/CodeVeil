  ...
  return (
    <div className="flex flex-col justify-center items-center flex-grow py-12">
      <div className="glass-panel p-8 rounded-2xl border border-green-500/20 max-w-md w-full">
        <h1 className="text-2xl font-bold text-green-50 mb-6 text-center">Sign In to CodeVeil</h1>
        ...
        <p className="mt-6 text-center text-zinc-400 text-sm">
          Don't have an account? <Link href="/auth/signup" className="text-green-400 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
